...
import { AlertCircle, BookOpen, BarChart2, TrendingUp, CheckCircle2 } from "lucide-react";

const storyStages = [
  {
    phase: "01",
    title: "The Chaos",
    story: "You start with excitement but no direction. You follow random signals, chase pumps, and feel the sting of every red candle. This is where most quit.",
  ...
  },
  {
    phase: "02",
    title: "The Awakening",
    story: "You realize trading is a skill, not a gamble. You start studying market structure, liquidity, and risk management. The fog begins to clear.",
  ...
  },
  {
    ...
    story: "Strategy meets execution. You stop trading every move and start waiting for your edge. You treat your capital with respect. Consistency is born.",
  ...
  },
  {
    phase: "04",
    title: "The Mastery",
    story: "Trading becomes boring because it's systematic. You follow your plan with robotic precision. Your P&L reflects your growth. You are a Master Trader.",
...
function StageCard({ stage, index, progress }: { stage: typeof storyStages[0], index: number, progress: any }) {
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <span className="text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-50">Phase {stage.phase}</span>
              <h3 className="text-2xl md:text-4xl font-bold text-white">{stage.title}</h3>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 py-4 border-t border-white/5">
            <span className="text-sm font-semibold uppercase tracking-wider opacity-40">The Challenge:</span>
            <span className="text-sm font-bold text-white/80">{stage.pain}</span>
          </div>
        </div>
      </div>
    </motion.div>
    ...
    >
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute top-16 md:top-24 text-center z-20 px-6"
        >
          <span className="text-[10px] md:text-sm font-bold text-blue-400 tracking-[0.3em] uppercase mb-2 md:mb-4 block" data-aos="fade-down">
            The Interactive Journey
          </span>
          <h2 className="text-3xl md:text-6xl font-bold text-white mb-2 md:mb-4" data-aos="fade-up">
            Your Transformation <span className="gradient-text">Story</span>
          </h2>
          <p className="text-slate-500 max-w-xl mx-auto text-sm md:text-base">
            Scroll to walk through the path of a master trader. Every step is a milestone in your new career.
          </p>
        </motion.div>
        ...
        <div className="absolute bottom-12 flex items-center gap-4 opacity-40">
          ...
          <span className="text-xs font-bold tracking-widest uppercase">Scroll to Progress</span>
        </div>
      </div>
    </section>
  );
